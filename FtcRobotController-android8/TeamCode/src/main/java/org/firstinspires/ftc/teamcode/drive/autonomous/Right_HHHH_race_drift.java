...
public class Right_HHHH_race_drift extends LinearOpMode {
    OpenCvCamera camera;
        ...
        if(tagOfInterest == null){
            ...
            if (vision == 1) {
                ...
                TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                        .addTemporalMarker(.5, () -> SlideMotor.setTargetPosition(3900))
                        .addTemporalMarker(.3, () -> BlockServo.setPosition(0.85))
                        .lineToLinearHeading(new Pose2d(61, 4.3,Math.toRadians(90)))
//                       .lineToSplineHeading(new Pose2d(61, 4.3, Math.toRadians(90))) //moving to high post

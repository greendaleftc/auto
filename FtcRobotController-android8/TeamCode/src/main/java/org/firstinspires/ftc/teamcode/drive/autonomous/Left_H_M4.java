...
public class Left_H_M4 extends LinearOpMode {
    ...
    // cone stack
    double coneStack_x = 51;
    double coneStack_y = 22.75;

    // height 1st cone from stack
    int cone1_height = 600;

    // height 2nd cone from stack
    int cone2_height = 430;

    // height 3rd cone from stack
    int cone3_hight = 320;

    // height 4th cone from stack
    int cone4_height = 160;

    // cone stack return
    double coneStack_x_return = 52;
    double coneStack_y_return = 24;

    // medium goal last
    double medGoal_x_last2 = 44;
    double medGoal_y_last2 = -8;
        ...
        if(tagOfInterest == null){
            ...
            if (vision == 1) {
                ...
                TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                        ...
                        .splineTo(new Vector2d(highGoal_x_first, highGoal_y_first), Math.toRadians(-50)) // new fluid movement
                        ...
                        .lineToSplineHeading(new Pose2d(coneStack_x_return, coneStack_y_return, Math.toRadians(270))) // back up to cone stack
                        .UNSTABLE_addTemporalMarkerOffset(-1.5, () -> ArmServo.setPosition(0.68)) // rotate claw arm
                        ...
                        .waitSeconds(.4)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ArmServo.setPosition(0)) // rotate claw arm to face post
                        .lineToSplineHeading(new Pose2d(medGoal_x_last2, medGoal_y_last2, Math.toRadians(-145))) // moving back to mid post
                        .waitSeconds(.1)

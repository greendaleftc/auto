...
public class Right_park_strat_123 extends LinearOpMode {
    OpenCvCamera camera;
...
//                        .waitSeconds(.5)
                ...
                TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                        ...
                        .waitSeconds(.5)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ArmServo.setPosition(0)) // rotate claw arm to face post
                        .lineToSplineHeading(new Pose2d(46, 6.5, Math.toRadians(135))) // moving back to mid post
                        .waitSeconds(.5)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ClawServo.setPosition(0.85)) // open claw lol #2 cones
                        .waitSeconds(.2)
                        // Go Back For 3rd Cone
                        ...
                        .waitSeconds(.5)
                        .forward(2.5)
                        .lineToSplineHeading(new Pose2d(40, -26, Math.toRadians(90))) // moving back to low post
                        .waitSeconds(.1)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ClawServo.setPosition(0.85)) // open claw lol #4 cones
                        .waitSeconds(.1)
                        //park in 3

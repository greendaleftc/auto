...
public class Right_H4 extends LinearOpMode {
    OpenCvCamera camera;
    ...
    // cone stack
    double coneStack_x = 49;
    double coneStack_y = -21.5;

    // first high goal
    double highGoal_x_first = 56;
    double highGoal_y_first = 11.5;

    // return high goal
    double highGoal_x_return = 57.6;
    double highGoal_y_return = 8.1;

    // med goal --- needs recheck
    double medGoal_x = 40.1;
    double medGoal_y = 3.3;
        ...
        if(tagOfInterest == null){
            ...
            if (vision == 1) {
                ...
                TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                        ...
                        .lineToSplineHeading(new Pose2d(highGoal_x_first, highGoal_y_first, Math.toRadians(45))) //moving to high post
                        ...
                        .lineToSplineHeading(new Pose2d(highGoal_x_return, highGoal_y_return, Math.toRadians(45))) // moving back to high post
                        .waitSeconds(.5)
                        ...
                        .waitSeconds(.2)
                        .lineToSplineHeading(new Pose2d(45, 10.5, Math.toRadians(0))) // ready for teleop
                        .build();
                ...
                TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(startPose)
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> ClawServo.setPosition(0.85)) // open claw lol #4 cones
                        .waitSeconds(.2)
                        .lineTo(new Vector2d(49,2))
                        //park in 3
                        .lineToSplineHeading(new Pose2d(49, -20, Math.toRadians(90))) //park in 3
                ...
                if (!isStopRequested())
                    drive.followTrajectorySequence(trajSeq);
                posLocation(drive.getPoseEstimate());
            }

    }

    void posLocation(Pose2d poseEstimate){
